			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: '32. Design Techniques & Frameworks', translations: { 'zh-CN': '32. 设计技术与框架' }, slug: 'c32' },
						{ label: '33. Design Patterns', translations: { 'zh-CN': '33. 设计模式' }, slug: 'c33' },
						{ label: '34. Cross-Platform & Cross-Language', translations: { 'zh-CN': '34. 跨平台与跨语言开发' }, slug: 'c34' },
					],
				},
				{
					label: 'Appendices',
					...
					items: [
						...
						{ label: 'D. Introduction to UML', translations: { 'zh-CN': 'D. UML 简介' }, slug: 'b04' },
					],
				},
			],
		}),
