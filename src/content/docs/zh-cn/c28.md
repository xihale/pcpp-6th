...
:::tip[本章内容]
- 什么是 software life cycle model，包括 `Waterfall Model`、`Sashimi Model`、`spiral-like models` 和 `agile`
- 什么是 software engineering methodology，包括 `Unified Process`、`Rational Unified Process`、`Scrum`、`Extreme Programming` 和 `Software Triage`
- 什么是 version control
:::
...
这份 manifesto 的全文（摘自 `http://agilemanifesto.org`）如下：
