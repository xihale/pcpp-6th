...
| Random access | Bidirectional capability, plus the following:`operator+, -, +=, -=, <,>, <=,>=, []` | Equivalent to raw pointers: support pointer arithmetic, array index syntax, and all forms of comparison. |
